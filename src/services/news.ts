import { fetchNewsFromGuardian } from "../api/guradian";
import { fetchNewsFromNewsOrg } from "../api/newOrg";
import { fetchNewsFromNewYorkTimes } from "../api/newyYorkTimes";
import { Category, Source, News } from "../types";
